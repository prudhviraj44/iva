// Mock data for IVAROBOTICS website
...
export const techFeatures = [
  {
    ...
    description: "Advanced pathfinding and obstacle avoidance",
    icon: "Navigation"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "All-terrain adaptive wheel systems",
    icon: "Truck"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "Edge computing with cloud sync",
    icon: "Database"
  },
  {
    id: 6,
    title: "Safety Optimized",
    description: "Multi-layer safety protocols and sensors",
    icon: "Shield"
  }
];
...
export const companyInfo = {
  ...
  subtitle: "Advanced Robotics Designed for the Real World",
